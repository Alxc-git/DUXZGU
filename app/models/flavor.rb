...
# product-page stage, `card_image` the vertical flavour picker shot, `packshot` the
# small cart/cross-sell shot, and `comparison_image` the shot that faces the rival
...
Flavor = Struct.new(:slug, :name, :note, :color_var, :spot_var,
                    ...
                    :card_image, :card_focus, :packshot, :comparison_image,
...
class Flavor
  ALL = [
    new(slug: "raspberry",  name: "Raspberry",  note: "Bold & refreshing",
        ...
        card_image:  "product/duwzgu-card-raspberry.png",       card_focus:  "center 52%",
        packshot:    "product/duwzgu-packshot-raspberry.png",
        comparison_image: "product/duwzgu-versus-raspberry.png", comparison_cutout: true),
    new(slug: "blueberry",  name: "Blueberry",  note: "Sweet & smooth",
        ...
        card_image:  "product/duwzgu-card-blueberry.png",       card_focus:  "center 50%",
    ...
    new(slug: "strawberry", name: "Strawberry", note: "Juicy & classic",
        ...
        card_image:  "product/duwzgu-card-strawberry.png",      card_focus:  "center 51%",
