module IconsHelper
  ...
  ICON_PATHS = {
    ...
    "users" => [ "M9 11a3.5 3.5 0 100-7 3.5 3.5 0 000 7z", "M2.5 20a6.5 6.5 0 0113 0",
                 "M16 4.3a3.5 3.5 0 010 6.8", "M17.5 14.2a6.5 6.5 0 014 5.8" ],
    "trend-up" => [ "M3 17l6-6 4 4 8-8", "M15 7h6v6" ],
    "trend-down" => [ "M3 7l6 6 4-4 8 8", "M15 17h6v-6" ],
    "grid" => [ "M4 4h7v7H4z", "M13 4h7v7h-7z", "M4 13h7v7H4z", "M13 13h7v7h-7z" ],
    "store" => [ "M4 9h16v11H4z", "M3 9l1.6-5h14.8L21 9", "M9 20v-6h6v6" ],
    "chart" => [ "M4 20V9", "M10 20V4", "M16 20v-7", "M22 20H2" ],
    "settings" => [ "M12 15a3 3 0 100-6 3 3 0 000 6z",
                    "M19.9 14.6a1.6 1.6 0 00.3 1.8l.1.1a2 2 0 11-2.8 2.8l-.1-.1a1.6 1.6 0 00-2.7 1.1v.3a2 2 0 11-4 0v-.2a1.6 1.6 0 00-2.7-1.1l-.1.1a2 2 0 11-2.8-2.8l.1-.1a1.6 1.6 0 00-1.1-2.7H4a2 2 0 110-4h.2a1.6 1.6 0 001.1-2.7l-.1-.1a2 2 0 112.8-2.8l.1.1a1.6 1.6 0 002.7-1.1V4a2 2 0 114 0v.2a1.6 1.6 0 002.7 1.1l.1-.1a2 2 0 112.8 2.8l-.1.1a1.6 1.6 0 001.1 2.7H22a2 2 0 110 4h-.2a1.6 1.6 0 00-1.5 1z" ],
    "logout" => [ "M9 20H5V4h4", "M16 16l4-4-4-4", "M20 12H10" ],
    ...
    # Speech bubble with three dots, for the support launcher.
    "chat" => [ "M4 5h16v11H9l-4 3.5V16H4z", "M8.5 10.5v.01", "M12 10.5v.01", "M15.5 10.5v.01" ],
    "sparkle" => [ "M12 3l1.9 5.1L19 10l-5.1 1.9L12 17l-1.9-5.1L5 10l5.1-1.9z" ],
    "send" => [ "M20 4L3.5 10.6l6.4 2.5 2.5 6.4z", "M20 4l-10.1 9.1" ],
