...
class PagesControllerTest < ActionDispatch::IntegrationTest
  setup do
    ...
    stores(:demo).update!(
      ...
      settings: stores(:demo).settings.merge(
        ...
        "legal_business_name" => "LUXTIME STYLE INC.",
  ...
  test "renders the French privacy policy and public contact details" do
    ...
    assert_select "a[href='mailto:contact@luxtimestyle.com']"
    assert_select "a[href='tel:+15145550100']"
    assert_select ".legal-page__summary", text: /LUXTIME STYLE INC\./
  ...
  test "footer links to the privacy policy and official email" do
    ...
    assert_select "footer a[href='mailto:contact@luxtimestyle.com']", text: "contact@luxtimestyle.com"
    assert_select "footer", text: /LUXTIME STYLE INC\./
  end
end
